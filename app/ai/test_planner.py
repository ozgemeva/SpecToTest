...
class BuildTestPlan:
    ...
    def build_test_planning_prompt(self, endpoint, request_schema, response_schema):
        ...
        5. Use only the rules defined in the API specification. Do not invent unsupported business rules or constraints.
        6. Return the generated test scenarios as structured JSON.
        7. Each test scenario should contain: scenario_name, test_type, target, rule, endpoint, http_method, path_params, query_params, request_body, expected_status, and expected_result.
