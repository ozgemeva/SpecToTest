...
from tests.unit_tests.mock_data.extract_responce_invalid_schema import (
...
from tests.unit_tests.mock_data.extract_schema_none import (
...
@pytest.fixture
def parser_with_extract_request_schema_none_details(
    monkeypatch, swagger_body_parameter_request_schema_none_details_data
):
...
@pytest.fixture
def parser_with_extract_request_schema_details(
    monkeypatch, swagger_body_paramete_request_schema_detail_data
):
    return create_mock_parser(
        monkeypatch, swagger_body_paramete_request_schema_detail_data
    )
...
@pytest.fixture
def parser_with_extract_response_schema_details(
    monkeypatch, swagger_body_paramete_response_schema_detail_data
):
    return create_mock_parser(
        monkeypatch, swagger_body_paramete_response_schema_detail_data
    )
...
@pytest.fixture
def parser_with_extract_response_schema_not200_details(
    monkeypatch, swagger_body_parameter_response_schema_not200_details_data
):
    return create_mock_parser(
        monkeypatch, swagger_body_parameter_response_schema_not200_details_data
    )
...
@pytest.fixture
def parser_with_extract_response_schema_nondict_details(
    monkeypatch, swagger_body_parameter_response_schema_nondict_detais_data
):
    return create_mock_parser(
        monkeypatch, swagger_body_parameter_response_schema_nondict_detais_data
    )
