...
def test_resolve_nested_references(schema_with_nested_reference,
                                   swagger_with_category_definition,):
    se = SchemaExtractor()
    sr = SchemaResolver()
    
    result = se.resolve_nested_references(schema_with_nested_reference,
                                          swagger_with_category_definition,sr,)
